...
#define _DUTY_MIN 580.0 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1465.0 // servo neutral position (90 degree)
#define _DUTY_MAX 2350.0 // servo full counterclockwise position (180 degree)
